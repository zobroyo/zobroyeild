if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("Zobro Yield is already running!", 0)
    return
end
...
-- xylex & europa
local iyassets = {
    ["Zobroyield/assets/bindsandplugins.png"] = "rbxassetid://5147695474",
    ["Zobroyield/assets/close.png"] = "rbxassetid://5054663650",
    ["Zobroyield/assets/editaliases.png"] = "rbxassetid://5147488658",
    ["Zobroyield/assets/editkeybinds.png"] = "rbxassetid://129697930",
    ["Zobroyield/assets/edittheme.png"] = "rbxassetid://4911962991",
    ["Zobroyield/assets/editwaypoints.png"] = "rbxassetid://5147488592",
    ["Zobroyield/assets/imgstudiopluginlogo.png"] = "rbxassetid://4113050383",
    ["Zobroyield/assets/logo.png"] = "rbxassetid://1352543873",
    ["Zobroyield/assets/minimize.png"] = "rbxassetid://2406617031",
    ["Zobroyield/assets/pin.png"] = "rbxassetid://6234691350",
    ["Zobroyield/assets/reference.png"] = "rbxassetid://3523243755",
    ["Zobroyield/assets/settings.png"] = "rbxassetid://1204397029"
}
...
if makefolder and isfolder and writefile and isfile then
    pcall(function() -- good executor trust
        ...
        for _, folder in {"Zobroyield", "Zobroyield/assets"} do
        ...
        for path in iyassets do
            if not isfile(path) then
                writefile(path, game:HttpGet((path:gsub("Zobroyield/", assets))))
            end
        end
    end)
end
...
Title.TextSize = 18
Title.Text = "Zobro Yield FE v" .. currentVersion
...
SettingsButton.Image = getcustomasset("Zobroyield/assets/settings.png")
...
ReferenceButton.Image = getcustomasset("Zobroyield/assets/reference.png")
...
ColorsButton = makeSettingsButton("Edit Theme",getcustomasset("Zobroyield/assets/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds",getcustomasset("Zobroyield/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases",getcustomasset("Zobroyield/assets/editaliases.png"))
...
Positions = makeSettingsButton("Edit/Goto Waypoints",getcustomasset("Zobroyield/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds",getcustomasset("Zobroyield/assets/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins",getcustomasset("Zobroyield/assets/bindsandplugins.png"),743)
...
CloseImage.Image = getcustomasset("Zobroyield/assets/close.png")
...
PinImage.ZIndex = 10
PinImage.Image = getcustomasset("Zobroyield/assets/pin.png")
...
Logo.Image = getcustomasset("Zobroyield/assets/logo.png")
...
ExitImage_2.Image = getcustomasset("Zobroyield/assets/close.png")
...
Img.Image = getcustomasset("Zobroyield/assets/imgstudiopluginlogo.png")
Img.ZIndex = 10
...
ExitImage_3.Image = getcustomasset("Zobroyield/assets/close.png")
...
ExitImage_5.Image = getcustomasset("Zobroyield/assets/close.png")
...
ImageLabel.Image = getcustomasset("Zobroyield/assets/minimize.png")
...
ImageLabel_2.Image = getcustomasset("Zobroyield/assets/close.png")
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("Zobroyield/assets/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("Zobroyield/assets/settings.png"),Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
createPopup = function(text)
    ...
    ExitImage.Image = getcustomasset("Zobroyield/assets/close.png")
    ExitImage.ZIndex = 10
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Zobro Yield Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the Zobro Yield support server.'}
...
CMDs[#CMDs + 1] = {NAME = 'Zobrojump / infjump', DESC = 'Allows you to jump before hitting the ground'}
CMDs[#CMDs + 1] = {NAME = 'unZobrojump / uninfjump', DESC = 'Disables infjump'}
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/Zobroyield/master/source'))()")
	end
end)
...
addcmd("infjump", {"Zobrojump"}, function(args, speaker)
...
addcmd("uninfjump", {"unZobrojump", "noinfjump", "noZobrojump"}, function(args, speaker)
	if infJump then infJump:Disconnect() end
	infJumpDebounce = false
end)
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = game:HttpGet("https://raw.githubusercontent.com/EdgeIY/Zobroyield/master/version")
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("Unstable Device", "On mobile, Zobro Yield may have issues or features that are not functioning correctly.") end
end)
